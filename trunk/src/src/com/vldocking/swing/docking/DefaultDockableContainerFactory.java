...
/**
 * Default implementation of the DockableContainerFactory. <p> Uses
 * <code>DockView</code> as a <code>SingleDockableContainer</code>, and
 * <code>DockTabbedPane</code> as a <code>TabbedDockableContainer</code> <p>
...
public class DefaultDockableContainerFactory extends DockableContainerFactory {
	 ...
	 * from the top. This implementation uses the following components : <ul>
	 * <li> DockView for standard dockables <li> TabbedDockView for dockable
	 * contained in a tabContainer <li> MaximizedDockView for maximized
	 * dockables <li> DetachedDockView for floating dockables. </ul>
	 * 
	 * @see DockView
	 * @see TabbedDockView
	...
	/**
	 * Returns the container used for tabbed docking. <p> Current implementation
	 * uses the DockTabbedPane class.
	 * 
	 * @see DockTabbedPane
	 */
