...
public class DockViewAsTab extends DockView implements SingleDockableContainer {
	...
	// flags to hide/show buttons in the title bar (they are always visible in
	// the contextual menu, but might
	// take too much space on the titles (for example a minimum set could be
	// hide/float/close
	...
	public void setDockableAsTab(final Dockable d) {
		this.dockable = d;
		if(title != null) { // still needed as removeing it triggers
							// Exception... we'll have to
	...
	public void resetTabIcons() {
		...
		// this is an attempt to create the set of icons displayed for this
		// dockable
		// currently, only "close" is managed, but other buttons could be added,
		// as
