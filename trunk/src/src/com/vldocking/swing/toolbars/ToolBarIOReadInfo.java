 ...
 * 
 * <p> returns useful informations such as the toolbars registered and
 * successfully loaded, and the ones not loaded.
 * 
...
public class ToolBarIOReadInfo {
	...
	/**
	 * returns the list of toolbars that were successfully loaded from the
	 * toolbarIO operation
	 */
	...
	/**
	 * returns the list of toolbars that weren't loaded from the stream (but
	 * registered)
	 */
	...
	/**
	 * Return the list of toolbars names (String) found in the stream but not
	 * registered (these toolbars cannot be loaded, so the API can only report
	 * their name).
	 */
