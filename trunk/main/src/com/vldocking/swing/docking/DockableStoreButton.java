...
/**
 * A Button that can be used to store a dockable (for example to allow moving a
 * dockable between two workspaces).
 * 
 * <p> The button is able to display the Icon, text and toolip of a dockable
 * key, and can be used as a drag source (to initiate a drop into a desktop).
 * 
...
public class DockableStoreButton extends JButton implements DockDropReceiver, DockableDragSource {
	...
	/**
	 * when a dockable is dragged above this button, the button stores it as its
	 * new target dockable.
	 * 
	 * @see #getDockable()
	 */
	...
	/**
	 * Override this method if you want to change the display (text and icon) of
	 * this button and the default settings don't suit your needs.
	 */
	...
	/**
	 * Returns the text used as tooltip for this button when no dockable is
	 * stored
	 */
	...
	/**
	 * Updates the text used as tooltip for this button when no dockable is
	 * stored
	 */
	...
	/**
	 * Returns the text used for as tooltip this button when a dockable is
	 * stored
	 */
	...
	/**
	 * Updates the text used as tooltip for this button when no dockable is
	 * stored. The special value '&1' will be replaced by the name of this
	 * dockable. <p> For example "&1 stored" could be replaced by
	 * "MyDockable stored"
	 */
