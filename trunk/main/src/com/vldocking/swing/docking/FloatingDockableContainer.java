...
/**
 * The interface describing a Floating window used to display one or more
 * dockables <p> Objects implementing this interface must be instances of
 * JDialog , as the pack(), setVisible(), setLocation(), dispose() etc. are
 * assumed.
 * 
...
public interface FloatingDockableContainer {
	 ...
	 * This will happen when drag-n-dropping a whole tab container from the
	 * desktop.
	 */
