...
/**
 * A constraint used to specify how a dockable is tied (anchored) to its
 * containing parent .
 * 
...
public class AnchorConstraints {
	...
	/**
	 * Field describing a dockable anchored to the TOP border of its ancestor
	 * container
	 */
	...
	/**
	 * Field describing a dockable anchored to the LEFT border of its ancestor
	 * container
	 */
	public static final int ANCHOR_LEFT = 2;

	/**
	 * Field describing a dockable anchored to the BOTTOM border of its ancestor
	 * container
	 */
	public static final int ANCHOR_BOTTOM = 4;

	/**
	 * Field describing a dockable anchored to the RIGHT border of its ancestor
	 * container
	 */
	 ...
	 * 
	 * @param anchor value expressed as a bitwise OR between ANCHOR_ fields (for
	 *            example ANCHOR_TOP|ANCHOR_LEFT)
	 * 
	 */
	...
	/**
	 * Returns the anchor value of this contraints object. <p> Anchor is
	 * expressed as a bitwise OR between ANCHOR_ fields (for example
