...
/**
 * A basic implementation of Dockable. <p> It's a JPanel with a BorderLayout,
 * and it can display a single Dockable. <p> This class is provided as an
 * intermediary between a User Component and the docking desktop (for example,
...
public class DockablePanel extends JPanel implements Dockable {
	...
	/**
	 * Removes all contained components (normally no more than one), and put
	 * this <code>comp</code> on the center area of the BorderLayout.
	 * */
