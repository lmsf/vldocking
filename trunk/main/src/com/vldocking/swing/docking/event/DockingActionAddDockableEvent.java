...
/**
 * A DockingActionEvent describing the first insertion of a dockable either
 * inside a desktop docking panel (main panel) or into a compoundDockable
 * (nested) container.
 * 
...
public class DockingActionAddDockableEvent extends DockingActionDockableEvent {
	 ...
	 * 
	 * @param parentContainer the container (DockingPanel or
	 *            CompoundDockingPanel) into which this dockable is goint to be
	 *            added.
	 */
