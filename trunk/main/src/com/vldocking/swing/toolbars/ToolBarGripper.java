...
/**
 * The component used to have a "grip" action on a toolbar (Drag and Drop
 * support)
 * 
...
public class ToolBarGripper extends JComponent {
	...
	public void setOrientation(int orientation) {
		...
		firePropertyChange(PROPERTY_ORIENTATION, old, orientation); // not used
																	// by the
																	// framwork,
																	// but might
																	// be
	...
	/**
	 * Returns the orientation of this gripper
