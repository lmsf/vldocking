...
/**
 * An event describing a basic state change. <p> Baic state changes include :
 * <ul> <li> Maximize/Restore <li> Float (just detach : attach is expressed with
 * split/addDockable/createTab events) <li> Hide (just hide : show is expressed
 * with split/addDockable/createTab events) </ul>
 * 
