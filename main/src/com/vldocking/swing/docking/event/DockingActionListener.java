...
/**
 * A listener to docking actions. <p> This listener can be used to be notified
 * of docking actions and to react to them (including vetoing).
 * 
...
public interface DockingActionListener {
	 ...
	 *            DockingActionEvent are used to reflect different types of
	 *            action (DockingActionCloseEvent when a dockable is closed,
