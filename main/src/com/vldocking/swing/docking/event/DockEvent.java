...
/**
 * Abstract superclass of drag and drop docking events. <P> This class holds a
 * reference to the source of the event and its mouse event.
 * 
...
public abstract class DockEvent {
	...
	/**
	 * The action corresponding to the drag and drop gesture (actions can be
	 * seen as allowed docking gestures)
	 */
	...
	/**
	 * Returns the MouseEvent which is the cause of this DockEvent. <p> <b> note
	 * that mouse coordinates are converted into the target's coordinates.</b>
	 * 
	...
	/**
	 * Returns a reference of the desktop in which the docking event takes
	 * place. <p> As of version 2.1, this method returns the "target" desktop
	 * (the one in which the drop will occur) <p> To get a reference of the
	 * "source" desktop, use the DockableState information provided by the
	 * DockingContext.
	 * 
	 */
