...
/**
 * An abstract factory used by the <code>DockingDesktop</code> to create
 * instance of Dockable containers. <p> This factory enables API Extenders to
 * change part of the behaviour on the DockingDesktop (mostly about look and
 * feel issues) without modifying the code of that central class.
 * 
 ...
 * @version 1.1
 * @update 2007/01/08 Lilian Chamontin : updated to declare a new titlebar
 *         factory method
 * */
public abstract class DockableContainerFactory {
	...
	/**
	 * Constant used to describe the type of usage a SingleDockableContainer is
	 * for
	 */
	...
	/**
	 * This method is called by the DockingDesktop whenever a dockable is
	 * inserted in its containment hierachy.
	 * 
	 */
	...
	/**
	 * This method is called when a tab insertion is requested by the
	 * DockingDesktop.
	 */
	 ...
	 * and put in the FLOATING state. <p> The floating container must be an
	 * instanceof Dialog or Window.
	 */
	public abstract FloatingDockableContainer createFloatingDockableContainer(Window owner);

	/**
	 * This method is invoked when a dockable container needs to install a title
	 * bar. <p> This method is used by the standard implementation of Docking
	 * (DockView, etc) but is optional for other implementations, as currently
	 * the titlebar isn't specified as a core component of the docking framework
	...
	/**
	 * Returns the current factory. <p> it no factory has been provided, it will
	...
	/**
	 * Changes the factory to be used by DockingDesktop. <p> Note that this
	 * change is not propagated to already docked components.
	 * */
