...
/**
 * Interface describing a container that can be used to display more than one
 * Dockable in a Tabbed Pane fashion. <p> This interface is meant for API
 * Extenders in order to provide new kinds of TabbedDockableContainers (the
