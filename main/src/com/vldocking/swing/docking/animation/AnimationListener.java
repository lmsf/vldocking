 ...
 * of an animation process (animation start and end). <p> This interface is used
 * by ComponentAnimator, generally to block events management during animation
 * phase.
 * 
...
public interface AnimationListener {
	...
	/**
	 * This method is invoked when the animation state change. <P> Changes are
	 * relative to animation start, sequence(frame) and end.
	 * */
