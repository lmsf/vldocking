...
public class AnimationEvent {
	...
	/**
	 * state identifying a change in the animation (the component has changed of
	 * bounds)
	 */
	 ...
	 * @param state the state of animation (ANIMATION_START , ANIMATION_FRAME or
	 *            ANIMATION_END)
	 * */
	...
	/**
	 * returns the state of the animation (ANIMATION_START, ANIMATION_FRAME or
	 * ANIMATION_END)
	 */
	public int getState() {
		return state;
