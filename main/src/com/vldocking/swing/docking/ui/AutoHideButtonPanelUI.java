...
/**
 * The UI associated with the AutoHideButtonPanel. <p> This UI uses the
 * following properties : <ul> <li>
 * UIManager.getBorder("AutoHideButtonPanel.topBorder") <li>
 * UIManager.getBorder("AutoHideButtonPanel.bottomBorder") <li>
 * UIManager.getBorder("AutoHideButtonPanel.leftBorder") <li>
 * UIManager.getBorder("AutoHideButtonPanel.rightBorder") </ul> <p> These
 * borders are used accordingly to the border zone (TOP, LEFT..) of the used
 * AutoHideButtonPanel.
 * 
