...
/**
 * The UI delegate for the AutoHideExpandPanel component. <p> This class is
 * mostly a placeholder in the case the developper would like to provide a
 * custom replacement for the expand panel look and feel.
 * 
