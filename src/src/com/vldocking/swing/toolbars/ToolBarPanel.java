 ...
 * 
 * <p align="center"><img src="doc-files/overview.gif"><br> The ToolBarPanel is
 * a JPanel with a ToolBarPanelLayout. It support horizontal and vertical
 * orientation, and can contain one or more VLToolbars (with given
 * ToolBarContraints for positionning). </p>
 * 
...
public class ToolBarPanel extends JPanel {
	 ...
	 * 
	 * @param align the alignment value The value of the alignment argument must
	 *            be one of <code>FlowLayout.LEFT</code>,
	 *            <code>FlowLayout.RIGHT</code>, <code>FlowLayout.CENTER</code>,
	 *            <code>FlowLayout.LEADING</code>, or
	...
	/**
	 * Helper function to convert a JToolBar into multiple VLToolBar objects.
	 * The JToolBar is split at the separator boundary to create VLToolbars
	 * 
	...
	/*
	 * Updates the orientation of this toolbar. Valid values are
	 * SwingConstants.HORIZONTAL and VERTICAL
	 */
	...
	/**
	 * Returns the optional background painter for this toolbar panel (may be
	 * null)
	 * 
	 * @since 2.1.4
	 */
